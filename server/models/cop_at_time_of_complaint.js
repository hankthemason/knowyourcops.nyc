export class CopAtTimeOfComplaint {
	...
	async create(cop_at_time_of_complaint) {
		...
		try {
			await this.db.run(`INSERT INTO cop_at_time_of_complaint(id, cop_id, complaint_id, rank, assignment, age)
						VALUES(NULL, '${cop_at_time_of_complaint.unique_mos_id}', '${cop_at_time_of_complaint.complaint_id}', '${cop_at_time_of_complaint.rank_abbrev_incident}', 
						'${cop_at_time_of_complaint.command_at_incident}', '${cop_at_time_of_complaint.mos_age_incident}')`)
		} catch(error) {
